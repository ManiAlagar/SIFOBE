...
namespace SIFO.APIService.Hospital.Controllers
{
    ...
    public class DrugController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("")]
        [ProducesResponseType(typeof(ApiResponse<Model.Entity.Drug>), StatusCodes.Status201Created)]
        ...
        [HttpPut]
        [Route("{id}")]
        [ProducesResponseType(typeof(ApiResponse<Model.Entity.Drug>), StatusCodes.Status200OK)]
