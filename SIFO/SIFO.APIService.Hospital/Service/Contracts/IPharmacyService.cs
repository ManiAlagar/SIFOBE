...
namespace SIFO.APIService.Hospital.Service.Contracts
{
    ...
    {
        public Task<ApiResponse<PagedResponse<PharmaciesResponse>>> GetPharmacyAsync(int pageNo, int pageSize, string filter, string sortColumn, string sortDirection, bool isAll,string pharmacyType);
        ...
        public Task<ApiResponse<List<PharmaciesResponse>>> GetMyPharmacyAsync(string pharmacyType);
    }
}
