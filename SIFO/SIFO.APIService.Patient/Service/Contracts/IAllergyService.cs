...
namespace SIFO.APIService.Patient.Service.Contracts
{
    ...
    {
        public Task<ApiResponse<PagedResponse<AllergyResponse>>> GetAllAllergyAsync(int pageNo, int pageSize, string filter, string sortColumn, string sortDirection, bool isAll);
