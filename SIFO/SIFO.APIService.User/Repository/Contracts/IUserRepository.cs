...
namespace SIFO.APIService.User.Repository.Contracts
{
    public interface IUserRepository
    {
        ...
        public Task<PagedResponse<UserResponse>> GetAllUsersAsync(int pageIndex, int pageSize, string filter, string sortColumn, string sortDirection, bool isAll, long? RoleId);
    }
}
